...
class _HomePageState extends State<HomePage> {
  ...
  final tabs = [
    ...
    const QRCodeScreen(),
    const Center(child: Text('restaurants')),
    const ProfileScreen()
  ];
                      ...
                      style: ButtonStyle(
                        shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                          RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20.0), // Установите радиус сглаживания по вашим требованиям
                          ),
                        ),
                        backgroundColor: MaterialStateProperty.all<Color>(const Color.fromARGB(255, 128, 0, 255)),
                        padding: MaterialStateProperty.all<EdgeInsetsGeometry>(const EdgeInsets.symmetric(horizontal: 10, vertical: 5)), // Установите внутренний отступ по вашим требованиям
                      ),
